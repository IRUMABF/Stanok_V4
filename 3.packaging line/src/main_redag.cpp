...
const int DELAY_VACUM_SOPLO = 1100;     // Затримка після переключення клапана на вакуумування перед відпусканням присосок

// Процеси
const int DELAY_HEATING = 2000;          // Час нагріву
const int DELAY_HEATING_POSLE = 1000;    // Час передачі тепла від лєнти після виключення
